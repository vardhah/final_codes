...
if __name__ == '__main__':
    ...
    try:
        ...
        crashed=crashed['Kick_Speed'].values
        print(crashed)
        gmm=gmm_trainer(crashed)
        with open('gmm_1D', 'rb') as f:
          model = pickle.load(f)
        number_of_retraining=0
        ...
        env.closefile()
        print('finished')
        print('Number of retraining the GMM:',number_of_retraining)
